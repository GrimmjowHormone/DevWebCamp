    ...
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">
                DevWebCamp es una conferencia para desarrolladores de todos los niveles y se lleva acabo de forma presencial en linea
            </p>
        </div>
        <nav class="menu-redes">
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://github.com/">
                <span class="menu-redes__ocultar">Github
            </a>
        </nav>
    </div>
